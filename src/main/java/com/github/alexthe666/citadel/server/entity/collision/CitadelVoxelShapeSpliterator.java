...
public class CitadelVoxelShapeSpliterator extends AbstractSpliterator<VoxelShape> {
   ...
   public CitadelVoxelShapeSpliterator(
      ICollisionReader reader, @Nullable Entity entity, AxisAlignedBB aabb, BiPredicate<BlockState, BlockPos> statePositionPredicate
   ) {
         ...
         if (l != 3) {
            ...
            if (iblockreader != null) {
               ...
               if (this.statePositionPredicate.test(blockstate, this.mutablePos)
                  && (l != 1 || blockstate.isCollisionShapeLargerThanFullBlock())
